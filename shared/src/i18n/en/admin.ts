...
const admin: TranslationStrings = {
  ...
  'admin.tabs.replication': 'Postgres Mirror',
  'admin.tabs.notifications': 'Notifications',
  'admin.tabs.audit': 'Audit',
  // Postgres mirror (SQLite → Postgres replica)
  'replication.title': 'Postgres Mirror',
  'replication.subtitle': 'Replicate the SQLite database to an external Postgres server for robustness. SQLite stays the source of truth; the mirror is a downstream, read-only copy.',
  'replication.connection.urlLabel': 'Postgres connection string',
  'replication.connection.urlPlaceholder': 'postgres://user:password@host:5432/database?sslmode=require',
  'replication.connection.urlHint': 'Stored encrypted. This mirror is as sensitive as your primary database — secure the Postgres host accordingly. Add ?sslmode=require to use TLS.',
  'replication.test': 'Test connection',
  'replication.testing': 'Testing…',
  'replication.connected': 'Connected',
  'replication.notConnected': 'Not connected',
  'replication.schedule.title': 'Schedule',
  'replication.schedule.subtitle': 'How often the mirror runs.',
  'replication.enable': 'Enable scheduled mirror',
  'replication.enableHint': 'When on, the mirror runs automatically on the schedule below.',
  'replication.interval': 'Interval',
  'replication.hour': 'Hour',
  'replication.dayOfWeek': 'Day of week',
  'replication.dayOfMonth': 'Day of month',
  'replication.runNow': 'Replicate now',
  'replication.running': 'Replicating…',
  'replication.lastRun.title': 'Last run',
  'replication.lastRun.never': 'The mirror has not run yet.',
  'replication.lastRun.success': 'Success',
  'replication.lastRun.failed': 'Failed',
  'replication.lastRun.tables': '{tables} tables, {rows} rows in {ms}ms',
  'replication.toast.loadError': 'Could not load replication settings',
  'replication.toast.saved': 'Replication settings saved',
  'replication.toast.saveError': 'Could not save replication settings',
  'replication.toast.testSuccess': 'Connected to Postgres',
  'replication.toast.testFailed': 'Could not connect to Postgres',
  'replication.toast.runSuccess': 'Replication complete',
  'replication.toast.runFailed': 'Replication failed',
